...
def rubyconftest():
	...
	ctop_mentions = [['users', 'Number of times mentioned']] + [[item['username'], item['mention_count']] for item in response['top_mentions']]
	ctop_users = [['users', 'Number of tweets']] + [[item['username'], item['tweet_count']] for item in response['top_users']]
